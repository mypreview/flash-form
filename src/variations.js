		...
		[
			{
				...
				innerBlocks: [
					...
					[ 'button', { defaultValue: __( 'Contact us', 'flash-form' ) } ],
				],
				name: 'contact',
				scope: [ 'block' ],
			...
			},
			{
				...
				innerBlocks: [
					...
					[ 'button', { defaultValue: __( 'Send RSVP', 'flash-form' ) } ],
				],
				name: 'rsvp',
				scope: [ 'block' ],
			...
			},
			{
				...
				innerBlocks: [
					...
					[ 'textarea', { label: __( 'Other Details', 'flash-form' ) } ],
					[ 'button', { defaultValue: __( 'Register', 'flash-form' ) } ],
				],
				name: 'registration',
				scope: [ 'block' ],
			...
			},
			{
				...
				innerBlocks: [
					...
					[ 'button', { defaultValue: __( 'Book Appointment', 'flash-form' ) } ],
				],
				name: 'appointment',
				scope: [ 'block' ],
			...
			},
			{
				...
				innerBlocks: [
					...
					[ 'button', { defaultValue: __( 'Send Feedback', 'flash-form' ) } ],
				],
				name: 'feedback',
				scope: [ 'block' ],
